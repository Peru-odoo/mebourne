...
class HrExpenseSheet(models.Model):
    ...
    first_date = fields.Datetime(string='Date', help='First signature approved date', copy=False)
    second_signature = fields.Binary(string='Second approval', attachment=True)
    second_date = fields.Datetime(string='Date', help='Second signature approved date', copy=False)
